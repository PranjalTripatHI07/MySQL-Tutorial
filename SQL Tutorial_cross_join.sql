create database cross_join_concept;
use cross_join_concept;
...
select student.s_id, student.student_name, courses.course_id, courses.course_name, student.marks, student.grade, student.city
from courses
cross join student;
...
select customer_name, order_id, product, Amount
from customer
