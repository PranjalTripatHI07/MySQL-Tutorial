create database sql_practice_qusetion1;
use sql_practice_qusetion1;
...
select payment_mode, count(payment_mode) from customer
group by payment_mode;



select payment_mode, count(customer_name) from customer
group by payment_mode;